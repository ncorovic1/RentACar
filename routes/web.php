...
Route::get('/renting', function() {
    if (Auth::guest())
        ...
        $vehicles = App\Vehicle::first();
        return view('iznajmljivanje', $vehicles);
})->name('iznajmljivanje');

Route::get('/searchResults', 'VehicleController@displayAll')->name('pretraga');
...
Route::get('name/{name}', function($name) {
    ...
    if($user2 == null)
        echo "Korisnik sa traženim imenom ne postoji!";
    else
        echo $user2->surname;
});
